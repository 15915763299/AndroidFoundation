package com.demo.imageandcache.cache.loader;
...
import com.demo.imageandcache.App;
import com.demo.imageandcache.R;
import com.demo.imageandcache.Utils;
import com.demo.imageandcache.cache.DiskLruCache;
...
public class ImageLoader {
    ...
    private ImageLoader() {
        ...
        if (Utils.getAllocatableBytes(diskCacheDir) > DISK_CACHE_SIZE) {
            try {
    ...
    public void bindBitmap(final String uri, final ImageView imageView,
        ...
        // 通过设置Tag让ImageView最后设置图片时能显示指定的图片
