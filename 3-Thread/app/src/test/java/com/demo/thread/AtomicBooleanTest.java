...
public class AtomicBooleanTest {
    ...
    public void testSimulate() {
        AtomicBooleanSimulate ast = new AtomicBooleanSimulate();
        ...
        // 两个线程同时执行
        // 当第一个线程执行时，flag为true
        //      --> flag.compareAndSet(true, false)返回true，
        //      --> 修改flag为false，
        //      --> 进入sleep
        // 第二个线程执行flag.compareAndSet(true, false)时
        //      --> 返回false
        //      --> 进入修正递归。
     ...
     * 模拟 AtomicBoolean
     */
    private static class AtomicBooleanSimulate implements Runnable {
        /**
         * 初始flag为true
         */
