...
public class ActUseFile extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText edt_library, edt_book;
    private TextView tx_book_count;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        edt_library = findViewById(R.id.edt_library);
        edt_book = findViewById(R.id.edt_book);
        tx_book_count = findViewById(R.id.tx_book_count);
    ...
    protected void onResume() {
        ...
        bookCount = 0;
        library = null;
        tx_book_count.setText("Book Count: " + bookCount);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_create:
                String libraryName = edt_library.getText().toString();
