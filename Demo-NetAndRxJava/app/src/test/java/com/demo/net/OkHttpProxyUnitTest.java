...
public class OkHttpProxyUnitTest {
    ...
    private OkHttpClient socksClient =
    ...
    private OkHttpClient httpClient =
            new OkHttpClient.Builder().proxy(
                    new Proxy(
                            Proxy.Type.HTTP,
                            new InetSocketAddress("114.239.145.90", 808)
                    ))
                    // 自定义拦截器
    ...
    public void testOkHttpHttpProxy() throws IOException {
        ...
        System.out.println("http代理 响应==》" + (body == null ? "null" : body.string()));
    }
    ...
    public void testOkHttpSocksProxy() throws IOException {
        ...
        //获得响应
        ResponseBody body = response.body();
        System.out.println("socks代理 响应==》" + (body == null ? "null" : body.string()));
