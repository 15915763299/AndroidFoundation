...
public class ActGesture extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView tx_gesture = findViewById(R.id.tx_gesture);
        tx_gesture.setOnTouchListener(this);
        TextView tx_scale_gesture = findViewById(R.id.tx_scale_gesture);
        tx_scale_gesture.setOnTouchListener(this);
