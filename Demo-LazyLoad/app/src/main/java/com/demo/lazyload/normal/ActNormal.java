...
/**
 * @author 尉迟涛
 * create time : 2020/2/23 17:57
 * description :
 */
public class ActNormal extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fragments.add(NormalFragment.newInstance(1));
        fragments.add(NormalFragment.newInstance(2));
        fragments.add(NormalFragment.newInstance(3));
        fragments.add(NormalFragment.newInstance(4));
        fragments.add(NormalFragment.newInstance(5));
